  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <View style={styles.centerBlock}>
        ...
        <Text style={[styles.title, { fontFamily: fontSemi }]}>Quote</Text>
        <Text style={[styles.subtitle, { fontFamily: fontRegular }]}>Created Successfully</Text>
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          ...
          activeOpacity={0.85}
          onPress={() => router.replace('/quotes')}
        >
          <Text style={[styles.footerButtonTextPrimary, { fontFamily: fontSemi }]}>Go to Home</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
